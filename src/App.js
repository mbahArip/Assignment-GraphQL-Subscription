...
import { GET_TODO, GET_FILTERED_TODO } from 'graphql/todo/query';
import { ADD_TODO, UPDATE_TODO, DELETE_TODO } from 'graphql/todo/mutation';
import { SUBS_TODO } from 'graphql/todo/subscription';

function TodoList() {
	const { data, loading } = useSubscription(SUBS_TODO);
